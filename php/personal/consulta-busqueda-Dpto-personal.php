...
include ("/../../conexion/config.php");
			...
			$consulta = "SELECT personal.cedula, personal.nombre, personal.apellido, personal.telefono, departamentos.nombre_depto FROM `personal` INNER JOIN depto_pers on personal.cedula = depto_pers.id_cedula INNER JOIN departamentos on depto_pers.id_depto = departamentos.cod_depto WHERE nombre_depto='$departamento'";
