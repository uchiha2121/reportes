...
<form name="Validar_Get" id="formModCpuB" class="form-horizontal formModCpuB" method="POST" accept-charset="utf-8">
		...
		<div class="form-group" >
 				...
 				<label for="code" class="control-label">Codigo Case: </label>
  				...
  				<input type="text" id="proce" name="ProCpu" class="form-control" placeholder="¿De donde proviene el equipo?" value="<?php    echo $row['procedencia']  ?>" maxlength="30" minlength="3" required >
				...
				<label for="estadoO" class="control-label">Estado del case: </label>
										...
										<select id="estadoO" name="estado" class="form-control" required >
											   <option value="">Elije Una opcion</option> 
...
while ($row2 = mysqli_fetch_array($resultado2)) {?>
			...
			<tr>
					...
					<td><input type="text" name="descripcion[]" class="form-control" placeholder="Descripcion" id="descripcion" value="<?php    echo $row2['especificacion']  ?>" required ></td>
					<td><botton class="btn btn-danger">Eliminar</botton></td>
