...
<form id="formPresBdep" method="POST"  accept-charset="utf-8" class="navbar-form navbar-left" role="search">
...
<form  id="formPresEU" method="POST"  accept-charset="utf-8" class="navbar-form navbar-left" role="search">
			...
			<div class="form-group">
					  ...
					  <button name="busqueda" type="" class="btn btn-info">Historial En uso</button>
...
<form id="formPresBj" method="POST" accept-charset="utf-8" class="navbar-form navbar-left" role="search">
			...
			<div class="form-group">
					  ...
					  <button name="busqueda" type="" class="btn btn-warning">Historial de baja</button>
